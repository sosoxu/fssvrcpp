...
| **P6** | 元数据记录语义完整化 | `File.Generic` 全字段、版本链、staging→persistent 搬迁与回滚、`getFileList`、DMS、Delivery | `ctest -L phase6` | 🚧 **进行中（切片 5/6：C6.3/C6.4/C6.5/C6.6/C6.7/C6.8 已满足）** |
...
> **剩余**：GC 租约/幂等并发/tmp 名（C6.11~C6.13）、
...
**退出条件**：C7.1–C7.9 满足，证据写入 `docs/test-evidence/phase7.md`。
**此时"双协议"目标（G3）达成。**
