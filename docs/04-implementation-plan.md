...
| **P9** | 硬化与交付 | 并发/容量基线（独立负载进程）、故障注入、指标、GC、打包、部署模板、运维手册；**定稿 ADR-006** | `ctest -L phase9 && scripts/run_all_gates.sh` | 🚧 **进行中（切片 1/3 完成 + 切片 2 全部完成；C9.1~C9.6、C9.11~C9.13、C9.15、C9.16、C9.25 满足；C9.12 已定稿）** |
...
> **当前进度（切片 1/3 完成 + 切片 2 的指标/GC/性能基线/ADR-006 全部完成）**：
> `ctest -L phase9` **5 测试 / 451 断言**（C9.1/C9.2/C9.3/C9.4/C9.5/C9.6/C9.11/C9.13/C9.15/C9.25 满足；
> C9.12/C9.16 见 `docs/adr/ADR-006-large-file-data-plane.md` 与 `docs/test-evidence/phase9-adr006.md`）。
...
> 边界条件见 ADR-006 §4）。
> **剩余**：切片 3 = 门槛纳入 P9（C9.7）+ 镜像（C9.8）+ 运维文档（C9.9）
