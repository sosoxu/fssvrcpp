...
| 阶段 4 后续（**P9 也未接**） | 组合根接 `config/fss.example.json`：现在仍是环境变量直读。P9 的 C9.9 逐键核对了 **156 个叶子键**，其中 **31 个已接通**、**125 个未接通**（逐键见 `docs/operations.md` §1.3），登记为未做而不是"已支持" |
